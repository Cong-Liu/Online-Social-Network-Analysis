...
consumer_key = '8w2P6c8Lwcd1CdOOI2UHonxVl'
consumer_secret = 'c0n6B99V4XnOFTHYvNmZBAZMlbKMkE932oLVvgjs1puAYC6GT2'
access_token = '761287935920668673-ZoZITfPvYdjjmBZ7KUX2fJCHbkVEG0I'
access_token_secret = 'vQNaYnoOx4PG2hGDlrcLlBpSNJ3DLqe6gfjJAfqzb0B6y'
...
def followed_by_hillary_and_donald(users, twitter):
    ...
    for u in users:
        if u['screen_name'] == 'HillaryClinton':
            ...
            d_friend = u['friends']
    common = Counter(h_friend + d_friend).most_common()
    ids = [i[0] for i in common if int(i[1]) > 1]
    if ids:
        request = robust_request(twitter, 'users/lookup', {'user_id': ids})
        result = []
        for r in request:
